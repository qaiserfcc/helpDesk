    ...
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 card p-6">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div className="rounded-md shadow-sm -space-y-px">
            ...
            <div>
              ...
              <input
                ...
                autoComplete="email"
                required
                className="appearance-none rounded-none relative block w-full px-3 py-2 border border-white/10 placeholder-gray-500 text-white focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm"
            ...
            <div>
              ...
              <input
                ...
                autoComplete="new-password"
                required
                className="appearance-none rounded-none relative block w-full px-3 py-2 border border-white/10 placeholder-gray-500 text-white rounded-b-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm"
          ...
          {error && (
            <div className="rounded-md bg-red-700/10 p-4 border border-red-600">
          ...
          <div className="mt-6">
            ...
            <div className="flex gap-2">
              <label
                className={`px-3 py-2 rounded-md border ${role === "user" ? "border-white bg-blue-900" : "border-white/10"}`}
              >
                <input
                  type="radio"
                  name="role"
              ...
              <label
                className={`px-3 py-2 rounded-md border ${role === "agent" ? "border-white bg-blue-900" : "border-white/10"}`}
              >
                <input
                  type="radio"
                  name="role"
              ...
              <label
                className={`px-3 py-2 rounded-md border ${role === "admin" ? "border-white bg-blue-900" : "border-white/10"}`}
              >
                <input
                  type="radio"
                  name="role"
