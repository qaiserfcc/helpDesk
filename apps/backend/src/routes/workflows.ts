...
router.get("/ticket/:ticketId/progress", authenticate, async (req, res, next) => {
  try {
...
router.post("/ticket/:ticketId/step/:stepId/complete", authenticate, async (req, res, next) => {
  try {
...
router.get("/ticket/:ticketId/current-step", authenticate, async (req, res, next) => {
  try {
